...
# Unset post-installation `$HOST` environmental variable, which defaults to hostname.
#
# NOTE: This has to be placed inside the .zshrc file so the `$HOST` variable is
# unset inside interactive sessions launched with `startx` aswell.
unset HOST
